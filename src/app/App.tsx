      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              { tier: 'Basic',    premium: '₹8-12',  cap: '₹400',  triggers: [t('heavy_rainfall'), t('extreme_heat')],                                                                    featured: false },
              { tier: 'Standard', premium: '₹13-20', cap: '₹600',  triggers: [t('heavy_rainfall'), t('extreme_heat'), t('severe_aqi'), t('zone_lockdown')],   featured: true  },
              { tier: 'Premium',  premium: '₹21-28', cap: '₹800',  triggers: [t('all_triggers')],                                                                                         featured: false },
            ].map(plan => (
              <div key={plan.tier} className={cn('rounded-xl border p-6', plan.featured ? 'border-[#06C167] bg-[#E6FAF1] shadow-lg scale-105' : 'border-gray-200 bg-white')}>
                ...
                <p className="text-sm text-gray-500 mt-2">Coverage cap: {plan.cap}</p>
