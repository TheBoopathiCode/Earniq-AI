  ...
  return (
    <div className="bg-gradient-to-br from-[#06C167] to-[#049150] text-white rounded-xl p-6">
      ...
      <div className="space-y-4">
        ...
        <div><p className="text-sm opacity-90 mb-1">Risk Assessment</p><p className="text-lg font-medium">{insight.risk_reason}</p></div>
        <div>
      ...
      <div className="mt-4 pt-4 border-t border-white/20">
        <p className="text-xs opacity-75">🤖 AI is actively monitoring zone conditions and worker income patterns</p>
      </div>
    </div>
  )
}
